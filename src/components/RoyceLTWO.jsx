...
import {
  ...
  sanandlandMarkData,
  tagData,
} from "../utils/sanandpagedatavalues.js";
...
// import Bangalore from "../assets/Secondpage/rajyashLevel2_sanand.jpg";
import Bangalore from "../assets/Secondpage/royce-one-8k-small.jpg";
...
import {
  roycelandMarkData,
  royceTwotagData,
} from "../utils/royceoneDatavalues.js";
...
const RoyceLTWO = () => {
  ...
  const filteredLagoonsData = sanandlandMarkData.find((el) => {
    return el.parentId;
  });
    ...
    <>
      ...
      >
        <SatvaHeader
          ...
          sanandlandMarkData={sanandlandMarkData}
          activePin={activePin}
          setOpen={setOpen}
          open={open}
        />
      ...
      >
        ...
        <Box className={rajyashStyles.imageMapContainer}>
          ...
          >
            ...
            {roycelandMarkData.map((landMark) => {
              {

...
import gokuldham from "../../assets/InteractiveVid/gokuldham.jpg";
...
const GokulDham = () => {
  ...
  const handleBack = () => {
    ...
    navigate("/interactive", {
      state: {
        ...
        overlayType: "gokuldham", // Preserve overlay state
  ...
  return (
    <Box>
      ...
      <Views360
        image={
          "https://arcus-greens.s3.ap-south-1.amazonaws.com/interactive/gokuldhamnew.jpg"
        }
      />
    </Box>
  );

...
export default function WingDetails() {
  ...
  const filteredData = WingData.polygondata?.filter((landMark) => {
    ...
    const resultwing = `${wingname}${wing}`;
  ...
  const groupedItemsFloors = groupByParentId(filteredSubData);
                          ...
                          hoveredFloor === item.floor && (
                            <>
                              ...
                              <foreignObject
                                ...
                                x={
                                  menuPosition.x +
                                    getScaledSize(parentIsNear + 200) ||
                                  cx + getScaledSize(1000)
                                }
                                y={menuPosition.y - 10}
                                width={300}
                                height={100}
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              textTransform: "none",
              fontSize: "14px",
              backgroundColor: view === "front" ? "gray" : "black",
              color: view === "front" ? "white" : "gray",
              "&:hover": {
                color: "white",
              },
              "&.Mui-disabled": {
          ...
          <Button
            ...
            sx={{
              ...
              fontSize: "14px",
              height: "30px",
              backgroundColor: view === "back" ? "gray" : "black",
              color: view === "back" ? "white" : "gray",
              "&:hover": {
                color: "white",
              },
              "&.Mui-disabled": {
...
const polycssforfloors = (
  ...
  opacity: isHovered ? 0.9 : 0.8,
  fill: isHovered ? "rgba(218,218,218,0.8)" : "rgba(255, 255, 255, 0)",
...
const hoverespinLandmarkcss = (getScaledSize, item) => ({
  ...
  padding: `${getScaledSize(18)}px ${getScaledSize(24)}px`,
  width: "fit-content",
});

...
export default function Brouchermodal({ brouchermodal, setBrouchermodal }) {
  const handleClosebrouchermodal = () => setBrouchermodal(false);
  ...
  return (
    <>
      <Modal open={brouchermodal} onClose={handleClosebrouchermodal}>
        <Box
          sx={{
            position: "absolute",
            top: "50%",
          ...
          >
            <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.11.174/build/pdf.worker.min.js">
              <Viewer
                fileUrl={brocuhure}
                defaultScale={0.55}
                onDocumentLoad={() => setShowPdf(true)}
